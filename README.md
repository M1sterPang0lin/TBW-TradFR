...
Tout est configuré pour qu'au prochain lancement du jeu via Steam, le texte anglais soit remplacé par la traduction.

## <ins>Pour la désinstallation</ins> :

Supprimez le dossier 'Bepinex" et les fichiers suivants :
- .doorstop_version
- changelog.txt
- doorstop_config.ini
- winhttp.dll
